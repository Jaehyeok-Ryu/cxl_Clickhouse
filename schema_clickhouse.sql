-- ====================================================================
--  ClickHouse TPC-H Columnar Sharded DDL Schema
--  Deploys Sharded tables utilizing local MergeTree engines
-- ====================================================================

-- --------------------------------------------------------------------
-- 1. Create Sharded Local Tables on both Workers
-- --------------------------------------------------------------------

-- REGION
CREATE TABLE IF NOT EXISTS region_local ON CLUSTER tpc_cluster
(
    r_regionkey Int32,
...
-- NATION
CREATE TABLE IF NOT EXISTS nation_local ON CLUSTER tpc_cluster
(
    n_nationkey Int32,
...
-- PART
CREATE TABLE IF NOT EXISTS part_local ON CLUSTER tpc_cluster
(
    p_partkey     Int32,
    p_name        String,
...
-- SUPPLIER
CREATE TABLE IF NOT EXISTS supplier_local ON CLUSTER tpc_cluster
(
    s_suppkey   Int32,
    s_name      String,
    s_address   String,
...
-- PARTSUPP
CREATE TABLE IF NOT EXISTS partsupp_local ON CLUSTER tpc_cluster
(
    ps_partkey    Int32,
    ps_suppkey    Int32,
    ps_availqty   Int32,
...
-- CUSTOMER
CREATE TABLE IF NOT EXISTS customer_local ON CLUSTER tpc_cluster
(
    c_custkey    Int32,
    c_name       String,
    c_address    String,
...
-- ORDERS
CREATE TABLE IF NOT EXISTS orders_local ON CLUSTER tpc_cluster
(
    o_orderkey      Int32,
    o_custkey       Int32,
...
-- LINEITEM
CREATE TABLE IF NOT EXISTS lineitem_local ON CLUSTER tpc_cluster
(
    l_orderkey      Int32,
    l_partkey       Int32,
    l_suppkey       Int32,
...
-- --------------------------------------------------------------------
-- 2. Create Distributed Query-routing Tables on Coordinator (Self-contained)
-- --------------------------------------------------------------------
